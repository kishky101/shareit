      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
        <div className='bg-secondaryColor p-3 flex flex-0.7 w-full'>
          <div className='flex justify-center items-center flex-col border-2 border-gray-300 p-3 w-full h-420'>
            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col item-center justify-center h-full cursor-pointer'>
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
          <input 
            ...
            className='outline-none text-2xl text-3xl font-bold border-b-2 border-gray-200 p-2'
          />
          {user && (
